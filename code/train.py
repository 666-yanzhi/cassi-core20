...
def run_overfit_probe(
    ...
    *,
    ...
    measurement, model_mask, supervision = (value[:1] for value in batch)
...
def run(config_path: Path) -> dict[str, Any]:
    ...
    split_manifest = {
        ...
        "warning": "Local behavior gate only; no formal test-set result.",
    }
    ...
    restore_model = build_model(config)
    ...
    return {
        ...
        "completed_epochs": completed_epochs,
        "overfit_relative_final_loss": overfit_probe["relative_final_loss"],
